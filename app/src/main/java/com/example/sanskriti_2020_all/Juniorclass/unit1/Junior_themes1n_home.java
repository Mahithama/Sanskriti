...
public class Junior_themes1n_home extends AppCompatActivity {
    ImageView act_1jl,act_2jl,act_3jl,act_4jl,return_activity;
    int i;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_junior_themes1n_home);
        act_1jl=findViewById(R.id.act_1);
        act_1jl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Junior_themes1n_home.this, Junior1_classroomrules1.class);
        ...
        act_2jl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Junior_themes1n_home.this, Junior1_fruits1.class);
                startActivity(intent);
            }
        } );
        ...
        act_3jl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Junior_themes1n_home.this,Junior1_senses.class);
        ...
        act_4jl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Junior_themes1n_home.this, Junior1_animalhouse_cover.class);
                startActivity(intent);
            }
        } );
        ...
        return_activity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Junior_themes1n_home.this, Junior1_themes_Home.class);
                startActivity(intent);
            }
        });
