...
public class ju5_literacy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        act_2n1t.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ju5_literacy.this, U_cover.class);
                startActivity(intent);
        ...
        act_3n1t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Intent intent=new Intent(ju5_literacy.this,Pattren_cover.class);
                Toast.makeText(ju5_literacy.this, "No more activities", Toast.LENGTH_SHORT).show();
                //startActivity(intent);
            }
        } );
        ...
        return_activity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ju5_literacy.this, ju5_themes.class);
                startActivity(intent);
            }
        });
