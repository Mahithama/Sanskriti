...
public class nur3_themes_home extends AppCompatActivity {
    ImageView n_home,n_logout,n_back,n_act_but,n_stories_but;
    int i;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nur3_themes_home);
        n_act_but=findViewById(R.id.act_jbut);
        n_act_but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(nur3_themes_home.this, nur3_themes_activities_home.class);
        ...
        n_stories_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //startActivity(intent);
                Toast.makeText(nur3_themes_home.this, "Will be updated soon", Toast.LENGTH_SHORT).show();
            }
        } );
        ...
        n_logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(nur3_themes_home.this, MainActivity.class);
                startActivity(intent);
            }
        } );
        ...
        n_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(nur3_themes_home.this, nur3_home.class);
                startActivity(intent);
            }
        } );
    }
