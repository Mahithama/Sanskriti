package com.example.sanskriti_2020_all.Nurseryclass;
...
public class Unitscreens_nursery extends AppCompatActivity {
    ImageView unit1n,unit2n,unit3n,unit4n,unit5n,unit6n,unit7n,logoutn;
    int i;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unitscreens_nursery2);
        unit1n=findViewById(R.id.unit1);
        unit1n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Unitscreens_nursery.this, Nursery_themes_home.class);
        ...
        unit2n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Intent intent=new Intent(Unitscreens_nursery.this, nur2_home.class);
                startActivity(intent);
        ...
        unit3n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                 Intent intent=new Intent(Unitscreens_nursery.this, nur3_home.class);
                startActivity(intent);
                //Toast.makeText(Unitscreens_nursery.this, "No Numeracy activities", Toast.LENGTH_SHORT).show();
            }
        } );
        ...
        unit4n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Intent intent=new Intent(Unitscreens_nursery.this, nur4_home.class);
               startActivity(intent);
                //Toast.makeText(Unitscreens_nursery.this, "No Numeracy activities", Toast.LENGTH_SHORT).show();
            }
        } );
        ...
        unit5n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Intent intent=new Intent(Unitscreens_nursery.this, nur5_home.class);
                startActivity(intent);
               // Toast.makeText(Unitscreens_nursery.this, "No Numeracy activities", Toast.LENGTH_SHORT).show();
            }
        } );
        ...
        unit6n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Unitscreens_nursery.this, Unit6home.class);
                startActivity(intent);
        ...
        unit7n.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Unitscreens_nursery.this, nur7_home.class);
                startActivity(intent);
                //Toast.makeText(Nursery_unit_one.this, "No Numeracy activities", Toast.LENGTH_SHORT).show();
            }
        } );
        ...
        logoutn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Unitscreens_nursery.this, MainActivity.class);
                startActivity(intent);
            }
        });
