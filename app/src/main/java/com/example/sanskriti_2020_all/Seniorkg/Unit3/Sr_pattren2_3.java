...
public class Sr_pattren2_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sr_pattren2_3);
    ...
    public void youCant(DragEvent event){
        mp = MediaPlayer.create(Sr_pattren2_3.this, R.raw.try_again_new);
        ...
        if(i==4){
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent act = new Intent(Sr_pattren2_3.this, Sn3_theme_activities.class);
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (v == findViewById(R.id.p1_c)) {
                        ...
                        if (clipData.equals("p1")) {
                            ...
                            mp = MediaPlayer.create(Sr_pattren2_3.this, R.raw.success);
                            mp.setAudioStreamType(AudioManager.STREAM_MUSIC);
                            mp.setLooping(false);
                            mp.start();
                            i++;
                            ...
                            mp = MediaPlayer.create(Sr_pattren2_3.this, R.raw.failure);
                            mp.setAudioStreamType(AudioManager.STREAM_MUSIC);
                            mp.setLooping(false);
                            mp.start();
                        }
