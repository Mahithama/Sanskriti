    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n_stories_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // startActivity(intent);
                Toast.makeText(Sn2_themes.this, "Will be updated soon", Toast.LENGTH_SHORT).show();
            }
        } );
        ...
        n_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Sn2_themes.this, Unitscreens_senior.class);
                startActivity(intent);
            }
        } );
        ...
        n_logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Sn2_themes.this, MainActivity.class);
                startActivity(intent);
            }
        } );
        ...
        n_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Sn2_themes.this, unit2_home.class);
                startActivity(intent);
            }
        } );
    }
